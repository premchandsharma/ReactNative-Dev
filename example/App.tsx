...
import {AppStorys, Banner, CaptureScreenButton} from '@appstorys/appstorys-react-native';
...
export default function App() {
  ...
  useEffect(() => {
    console.log('Tracking Home Screen');
    void AppStorys.trackScreen("Home Screen");
  }, []);

  return (
    <ScrollView ref={screenRef} style={{flex: 1}} contentContainerStyle={{padding: 20}}>
      ...
      <View style={{borderWidth: 2, borderColor: '#ddd', borderStyle: 'dashed', padding: 20, marginBottom: 15}}
        ...
        <Text style={{textAlign: 'center', fontStyle: 'italic'}} key="placeholder-text" testID="placeholder-content">
      ...
      <CaptureScreenButton screenName={"Home Screen"} key="capture-btn"/>

      <View
        style={{height: 100, backgroundColor: '#f8f9fa', marginTop: 20, justifyContent: 'center', alignItems: 'center'}}
